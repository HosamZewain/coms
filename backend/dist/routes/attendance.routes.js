...
router.get('/employee-monthly-report', (0, auth_middleware_1.authorize)(['Admin', 'HR', 'Director', 'Manager']), attendanceController.getEmployeeMonthlyReport);
router.post('/manual', (0, auth_middleware_1.authorize)(['Admin', 'HR']), attendanceController.addManualAttendance);
