...
export default function ActivityLogPage() {
    ...
    const { data: activities, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await api.get('/activities/recent?limit=50');
    ...
    const filteredActivities = activities?.filter((activity: any) => {
        const matchesSearch = searchTerm === '' ||
            ...
            (activity.actor?.firstName + ' ' + activity.actor?.lastName).toLowerCase().includes(searchTerm.toLowerCase());

        const matchesAction = filterAction === 'all' || activity.action === filterAction;

        const matchesUser = selectedUser === 'all' || activity.actorUserId === selectedUser;
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="mt-4 flex items-center justify-between text-sm">
                        ...
                        {(searchTerm || filterAction !== 'all' || selectedUser !== 'all') && (
                            <button
